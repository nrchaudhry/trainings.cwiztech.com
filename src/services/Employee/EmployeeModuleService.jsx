...
export const getOneEmployeeModule = async (id) => {
  const response = await Token.post('', {
    request_TYPE: 'GET',
...
export const addEmployeeModule = async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'POST',
    request_URI: `${setting.servicePath}employeemodule`,
...
export const updateEmployeeModule = async (data, id) => {
  const response = await Token.post('', {
    request_TYPE: 'PUT',
...
export const updateAllEmployeeModule = async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'PUT',
    request_URI: `${setting.servicePath}employeemodule`,
    request_BODY: JSON.stringify(data),
...
export const deleteProductEmployeeModule = async (id) => {
  const response = await Token.post('', {
    request_TYPE: 'DELETE',
    request_URI: `${setting.servicePath}employeemodule/${id}`,
    request_BODY: '',
...
export const searchEmployeeModule = async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'POST',
...
export const searchAllEmployeeModules= async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'POST',
...
export const advancedSearchEmployeeModule = async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'POST',
...
export const advancedSearchAllEmployeeModule = async (data) => {
  const response = await Token.post('', {
    request_TYPE: 'POST',
