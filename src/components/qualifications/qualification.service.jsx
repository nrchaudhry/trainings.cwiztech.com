import { api, uploadFile } from '../../../services/http-call-service.service';
import { setting } from '../../../settings';
import Token from "../../../services/get-token"; 
...
export const getAllDetail = (response) => {
  return response.map(item => getDetail(item));
};

export const getDetail = (response) => {
  if (response.productcategory_DETAIL) {
    response.productcategory = getDetail(JSON.parse(response.productcategory_DETAIL));
    response.productcategory_DETAIL = `${response.productcategory.productcategory_CODE} - ${response.productcategory.productcategory_NAME}`;
  }
  return response;
};
